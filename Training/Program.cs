...
{
    var OrderDto orderDtos = Orders.Select(o => new OrderDto
    {
        ...
        switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException($"Unknown status: {o.Status}")
        },
    ...
    public static readonly List<RawProduct> Products = new()
    {
    ...
    public static readonly List<RawOrder> Orders = new()
    {
    ...
    {
        Console.WriteLine($"Product: {orderDto.CustomerName}, Status: {orderDto.Status}, Date: {orderDto.CreatedAt}");
    }
